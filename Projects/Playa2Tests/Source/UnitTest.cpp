...
int UnitTestRunner::getNumResults() const noexcept { return results.size(); }

const UnitTestRunner::TestResult*
    UnitTestRunner::getResult (int index) const noexcept
{
...
{
    // Prevent the test runner from outputting anything. We will replace the
    // output with out own tooling.
    /* Logger::writeToLog (message); */
}

bool UnitTestRunner::shouldAbortTests() { return false; }

void UnitTestRunner::beginNewTest (UnitTest* const test,
...
{
    {
        ...
        jassert (r != nullptr); // You need to call UnitTest::beginTest() before
